...
{	
	...
	echo ""
	print_chars 60 -
    print_colored bold "Server capabilities:"
	...
	echo ""
    print_colored bold "OpenLiteSpeed:"
	...
	echo ""
	print_colored bold   "Aditional packages:" "Postfix"
	print_chars 60 -
	echo ""	
}
